...
### Possible entry points for your `<scripts>`

Generally speaking, when you do load your the easiest and most obvious way is to do it right in your HTML:

```html
<script src="./static/main.js"></script>
<script src="https://www.gruggletragger.com/gtag/js?id=UA43-1"></script>
```

However, as your site grows this, this becomes unmaintainable and also: What if you need to orchestrate your JS modules and 
